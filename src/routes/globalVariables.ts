...
function giveAffliction() {
    ...
    if (rand == 0) {
        ...
        currentAffliction.responseHR[1] =
            currentAffliction.responseHR[0] -
            Math.round(Math.random() * 10) -
            100;
        currentAffliction.responseBP1[1] =
            currentAffliction.responseBP1[0] -
            Math.round(Math.random() * 10) -
            90;
        currentAffliction.responseBP2[1] =
            currentAffliction.responseBP1[0] -
            Math.round(Math.random() * 6) -
            55;
        ...
        currentAffliction.responseQualitative[0].push(
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            24 + Math.round(Math.random() * 4) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            8 + Math.round(Math.random() * 3);
        currentAffliction.testResultsRespiratoryRate[2] =
            5 + Math.round(Math.random() * 1);
        ...
        currentAffliction.responseBP1[2] = Math.round(
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            25 + Math.round(Math.random() * 3) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            28 + Math.round(Math.random() * 3);
        currentAffliction.testResultsRespiratoryRate[2] =
            32 + Math.round(Math.random() * 2);

        currentAffliction.testResultsOxygenSaturation[0] =
            85 - Math.round(Math.random() * 10);
        currentAffliction.testResultsOxygenSaturation[1] =
            78 - Math.round(Math.random() * 7);
        currentAffliction.testResultsOxygenSaturation[2] =
            75 - Math.round(Math.random() * 5);
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            20 + Math.round(Math.random() * 5) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            25 + Math.round(Math.random() * 5);
        currentAffliction.testResultsRespiratoryRate[2] =
            30 + Math.round(Math.random() * 4);
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            17 + Math.round(Math.random() * 4) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            19 + Math.round(Math.random() * 3);
        currentAffliction.testResultsRespiratoryRate[2] =
            21 + Math.round(Math.random() * 2);

        currentAffliction.testResultsOxygenSaturation[0] =
            97 - Math.round(Math.random() * 10);
        currentAffliction.testResultsOxygenSaturation[1] =
            97 - Math.round(Math.random() * 7);
        currentAffliction.testResultsOxygenSaturation[2] =
            98 - Math.round(Math.random() * 5);
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            22 + Math.round(Math.random() * 4) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            26 + Math.round(Math.random() * 3);
        currentAffliction.testResultsRespiratoryRate[2] =
            30 + Math.round(Math.random() * 2);

        currentAffliction.testResultsOxygenSaturation[0] =
            94 - Math.round(Math.random() * 10);
        currentAffliction.testResultsOxygenSaturation[1] =
            92 - Math.round(Math.random() * 7);
        currentAffliction.testResultsOxygenSaturation[2] =
        ...
        currentAffliction.testResultsRespiratoryRate[0] =
            15 + Math.round(Math.random() * 3) - 2;
        currentAffliction.testResultsRespiratoryRate[1] =
            18 + Math.round(Math.random() * 2);
        currentAffliction.testResultsRespiratoryRate[2] =
            20 + Math.round(Math.random() * 1);

        currentAffliction.testResultsOxygenSaturation[0] =
            97 - Math.round(Math.random() * 5);
        currentAffliction.testResultsOxygenSaturation[1] =
            97 - Math.round(Math.random() * 3);
        ...
        currentAffliction.responseQualitative[0].push(
            "Visible wound on arm",
            "Bleeding",
        );
        currentAffliction.responseQualitative[1].push(
            "Bleeding more severely",
            "Swelling at wound",
        );
        currentAffliction.responseQualitative[2].push(
            "Blood clotting slightly",
            "Oozing at site of laceration",
        );
        ...
        currentAffliction.testResultsOxygenSaturation[0] =
            97 - Math.round(Math.random() * 10);
        currentAffliction.testResultsOxygenSaturation[1] =
            95 - Math.round(Math.random() * 7);
        currentAffliction.testResultsOxygenSaturation[2] =
            93 - Math.round(Math.random() * 5);

        currentAffliction.testResultsBloodGlucoseLevels[0] = "normal";
        currentAffliction.testResultsBloodGlucoseLevels[1] =
            "slightly elevated";
        currentAffliction.testResultsBloodGlucoseLevels[2] = "elevated";
